...
(defconst my-private-required nil)

(defun my-require-private ()
  (unless my-private-required
...
(defun my-chatfile-new/load ()
  (interactive)
  (my-load-org-ai)
  (my-chatfile-new))

(defun my-chatfile-fork/load ()
  (interactive)
  (my-load-org-ai)
  (my-chatfile-fork))
...
(defconst my-window-map
  (let ((keymap (make-sparse-keymap)))
    (my-bind-all
     ...
     ("a n"   my-chatfile-new/load)
     ("a f"   my-chatfile-fork/load)
